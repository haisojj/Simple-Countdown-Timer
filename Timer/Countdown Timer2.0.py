...
def borderless_toggle(event):
    if root.overrideredirect():
        root.overrideredirect(False)  # Make the window have borders
    else:
...
def show_instructions():
    ...
    popup.geometry("400x200")  # Set the size of the popup window
    ...
    text="Instructions:\n"
         ...
         "Ctrl + B to toggle borderless mode.\n",
...
root.bind("<Control-b>", borderless_toggle)
